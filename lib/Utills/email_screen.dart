...
class _EmailScreenState extends State<EmailScreen> {
  ...
  void skipEmail() async{
    emailController.clear();
    signupController.saveEmail("");
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (e)=> const MobileNumberScreen()));
  }
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  InkWell(
                    onTap: isLoading ? null : skipEmail,
                    child: const Row(
                      children: [
                        SizedBox(width: 20,),
                        Text("I'II do it later",style: TextStyle(color: AppColor.textColor,fontSize: 15)),
                        Spacer(),
                        Icon(Icons.arrow_forward_ios_rounded,color: AppColor.textColor,size: 17,),
                        SizedBox(width: 20,),
                      ],
                    ),
                  ),
