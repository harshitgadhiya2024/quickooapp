...
class _ConfirmEmailScreenState extends State<ConfirmEmailScreen> {
  ...
  final EmailVerificationController emailVerificationController = Get.put(
    EmailVerificationController(),
  );
  final UpdateUserDataController updateUserDataController = Get.put(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        color: isLoading ? Colors.grey : AppColor.bottomcurveColor,
                      ),
                      child:
                      Text(
                        "Send OTP",
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color:
                          isVerifying ? Colors.grey : AppColor.bottomcurveColor,
                        ),
                        child:
                        isVerifying
