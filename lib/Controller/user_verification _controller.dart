...
class UserVerificationController extends GetxController{
  ...
  Future<void> checkVerification() async{
    ...
    try{
      ...
      // final url = Uri.parse('https://quickoo.stylic.ai/quickoo/check-verified?user_id');
      //
      ...
      final response = await http.get(Uri.parse("https://quickoo.stylic.ai/quickoo/check-verified?user_id=${GlobleVariables.userId}"));
      print(response);
